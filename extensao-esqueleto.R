...
################################################################
# ETAPA 4: GERAR BANCO DE DADOS FINAL DO ESTADO COM DADOS DO SIDRA, ATLAS, SINASC, SIM,
# SINISA E INDICADORES
################################################################
# Tarefa 1: Fazer o merge dos bancos de dados criados nas etapas anteriores (SIDRA_UF, ATLAS_ UF,
# SINASC_UF, SIM_UF e SINISA_UF), sendo que as variáveis deverão seguir a ordem
# ANO, NIVEL, MUNICIPIO (uma única vez), variáveis do SIDRA, do ATLAS, do SINASC, do SIM e
